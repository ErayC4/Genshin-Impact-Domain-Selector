...
function DomainSelector({domainSelectorInformation}) {
  ...
  return (
    <div>
        {domainSelectorInformation.requirements.map((requirement, index) => (
                  ...
                  {index === isClicked ? (
                    ...
                    <div className="w-full scale-[1.04] transition-all duration-150 shadow-md shadow-white bg-amber-50 px-4 border-2 ring ring-white ring-opacity-100 border-gray-300">
                      <p className="text-gray-700 text-2xl py-3">
                        Domain Of {domainSelectorInformation.type}: {domainSelectorInformation.name}{" "}
